...
class DiscResampler:
    """
    Class for evaluating the moving average across multiple discrete populations of cells.
    Measurements are resampled from pools of cells generated by resampling the discrete populations.
    ...
    def bootstrap(self, idx, variable='green', f=np.mean, nbootstraps=1000):
        """
